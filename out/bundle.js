...
var TodoApp = module.exports.TodoApp = React.createClass({displayName: "TodoApp",
  getInitialState: function() {
  ...
  render: function() {
    return React.createElement("div", null, 
      React.createElement(TodoInput, {onAddTodo: this.onAddTodo}), 
      React.createElement(TodoList, {onRemoveTodo: this.onRemoveTodo, todos: this.state.todos})
    );
  }
});

var TodoInput = module.exports.TodoInput = React.createClass({displayName: "TodoInput",
  onAdd: function() {
    this.props.onAddTodo(this.refs.input.value);
  },
  render: function() {
    return React.createElement("div", null, 
      React.createElement("input", {ref: "input", placeholder: "add a todo item"}), 
      React.createElement("button", {onClick: this.onAdd}, "Add Todo")
    );
  }
});

var TodoList = module.exports.TodoList = React.createClass({displayName: "TodoList",
  render: function() {
...
var TodoItem = module.exports.TodoItem = React.createClass({displayName: "TodoItem",
  getInitialState: function() {
    return { removing: false };
  },
  onRemoveTodo: function(event) {
    this.setState({ removing: true });
    $.ajax('https://api.artsy.net/api/v1/system/up').then(function() {
  ...
  render: function() {
    return React.createElement("li", null, 
      ...
      React.createElement("button", {onClick: this.onRemoveTodo}, "X"), 
...
},{"jquery":2,"react":159,"underscore":160}],162:[function(require,module,exports){
...
ReactDOM.render(React.createElement(TodoApp, {todos: todos}), document.querySelector('#container'));

},{"./classes.jsx":161,"react":159,"react-dom":3,"underscore":160}]},{},[162]);
